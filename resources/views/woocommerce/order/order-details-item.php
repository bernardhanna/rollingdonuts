...
<tr class="bg-white border-t-2 border-grey-disabled  <?php echo esc_attr(apply_filters('woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order)); ?>">
    ...
    <td class="woocommerce-table__product-name product-name px-10 py-5 border-t-2 border-grey-disabled">
        <?php
    ...
    <td class="woocommerce-table__product-total product-total text-center border-t-2 border-grey-disabled">

...
<div class="shop_div woocommerce-checkout-review-order-div border-2 border-solid border-black-full rounded-20px boxshadow w-full">
    ...
    <div class="">
        ...
        ?>
                <div class="<?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item flex justify-between px-8 py-4 w-full border-b border-grey-border', $cart_item, $cart_item_key)); ?>">

...
?>
<div class="mx-auto px-0 mobile:px-4 pb-24 lg:max-w-max-848">
    <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
        <div class="border-black-full border-2 border-solid rounded-[10px] laptop:rounded-md-32 pt-10 pb-10 px-0 mobile:px-4 laptop:px-0" x-data="{ activeTab: 'sign-in', showLostPassword: false }">
            <div class="text-sm font-medium text-center">
                <ul class="flex flex-wrap -mb-px text-md-font font-reg420 signin-tabs pb-2 ml-auto mr-auto lg:w-[639px]">
                    <li class="w-1/2 relative">
                        <a id="signInTab" href="#" @click="activeTab = 'sign-in'; showLostPassword = false" :class="{ 'active-tab': activeTab === 'sign-in', 'inactive-tab': activeTab !== 'sign-in' }" x-text="showLostPassword ? 'Forgot Password' : 'Sign In'">
                        </a>
                    </li>
                    <li class="w-1/2 relative">
                        <a id="registerTab" href="#" @click="activeTab = 'register'; showLostPassword = false" :class="{ 'active-tab': activeTab === 'register', 'inactive-tab': activeTab !== 'register' }">
                            Register
                        </a>
                    </li>
                </ul>
            ...
            <div>
                <!-- Sign In Form -->
                <form class="w-full m-auto max-w-max-704 px-4 mobile:px-0" x-show="activeTab === 'sign-in' && !showLostPassword" method="post" action="<?php echo esc_url(wc_get_page_permalink('myaccount')); ?>">

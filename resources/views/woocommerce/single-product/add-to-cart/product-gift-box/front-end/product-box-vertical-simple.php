...
<div class="product_box_container">
    <div class="product_addon_container vertical_box full_opt">
                ...
                <div id="gift_box_0" data-box-count='0' class="product_gift_box active_bx_dtl">
                    ...
                    <div class="gift_box_top">
                        ...
                        <div class="reset_gt_box">
                            <a href="#" class="clear_cta"><img src="images/remove.png" alt=""><?php echo filter_var($circled_x); ?><?php echo esc_html__('Clear all items', 'extendons-woocommerce-product-boxes'); ?></a>
                        </div>
                    </div>
        ...
        <!-- Product Addon List -->
        <div class="product_addon_box full_opt">
            <?php
                                ...
                                <div class="pd_add_block_inner">
                                    ...
                                    <div class="pd_dtl">
                                        ...
                                        <div class="pd_addon_btns">
                                            ...
                                            ?>
                                                <div class="add_btn extbtns">
                                                    <a href="#" class="add_cta" data-id="<?php echo filter_var($product->get_id()); ?>"><?php echo filter_var($circled_plus); ?> &nbsp; <?php echo esc_html__('Add', 'extendons-woocommerce-product-boxes'); ?></a>
                                                </div>
                                                <div class="addon_qty extbtns">

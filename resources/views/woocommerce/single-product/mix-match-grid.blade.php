...
/**
 * Mix & Match Single gird Template
 */
if (!defined('ABSPATH')) {
    exit;
}
            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="mm_filled_col col-md-6 <?php echo esc_attr($mmboxlayout); ?>">
                        ...
                        <div id="addcollapse">
                            <button type="button" class="btn btn-basic" name="demo" id="collapsebox" data-toggle="collapse" data-target="#demo"><?php echo esc_html__('Box 1', 'extendons-woocommerce-product-boxes'); ?></button>

                            <div class="collapse" id="demo">
                                <div class="row">
                                    <input type="hidden" name="boxcol" id="boxcol" value="<?php echo esc_attr($mmboxcol); ?>">
                                    <?php
                                    for ($i = 0; $i < $mmboxqty; $i++) {
                                    ?>
                                        <div id="mm_item<?php echo filter_var($i); ?>" class="<?php echo filter_var($mmboxcol); ?> box-tobe-filled
									<?php
                                        if (!empty($prefilled[$i]['product_id'])) {
                                            echo 'mm_yes';
                                        }
                                        if (!empty($prefilled[$i]['pre_mandetory'])) {
                                            echo 'mendatory';
                                        }
                                    ?>
									" <?php
                                        if (!empty($prefilled[$i]['product_id'])) {
                                            echo "data-pid='" . filter_var($prefilled[$i]['product_id']) . "'";
                                        }
                                        ?>>
                        ...
                        <!-- alert danger -->
                        <div class="alert alert-success" id="mm_stack_full">
                    ...
                    <div class="mm_filled_col col-md-6 <?php echo esc_attr($mmboxlayout); ?>">
						...
						" <?php
                            ...
                            ?>>
                                    <?php
                                    if ('yes' == $prefilleds) {
                                        $temp = '<img src="' . esc_url(
                                            get_the_post_thumbnail_url(
                                                $prefilled[$i]['product_id']
                                            )
                                        ) . '">';
                                    }
                                    ?>

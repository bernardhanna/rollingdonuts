 ...
 * @Last Modified time: 2023-08-23 16:42:20
 */
        ...
        <div class="splide__track">
            <div class="splide__list">
                ...
                if ( $post_thumbnail_id ) {
                    ...
                    echo '<div class="'. (empty($image_ids) ? '' : 'splide__slide') .'"><img src="' . esc_url( $image_src ) . '" alt="' . esc_attr( $alt_text ) . '" /></div>';
                }

                foreach ( $image_ids as $image_id ) {
                    $image_src = wp_get_attachment_image_src( $image_id, 'full' )[0];
                    $alt_text = get_post_meta($image_id, '_wp_attachment_image_alt', true);
                    echo '<div class="splide__slide"><img src="' . esc_url( $image_src ) . '" alt="' . esc_attr( $alt_text ) . '" /></div>';
                }
                ?>
            </div>
        </div>

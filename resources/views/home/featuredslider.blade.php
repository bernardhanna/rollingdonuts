...
<div class="tablet-sm:max-w-sitewidth mx-auto featured-slide w-full flex flex-col tablet-sm:flex-row pb-8 tablet-sm:pb-0 h-full">
...
<div class="w-full tablet-sm:w-1/2 h-auto laptop:h-[800px]" style="background-color: {{ $bgColor }}">
                                <div class="h-full flex flex-col items-center">
<div class="relative max-tablet-sm:p-8 w-full tablet-sm:px-24 mt-12 xxl:mt-32 flex items-start flex-col">
...
<h3 class="text-lg-font tablet-sm:text-xl-font font-reg420 transition delay-700 duration-300 ease-in-out">{{ $donut->post_title }}</h3>
<p class="text-sm-font tablet-sm:text-base-font text-left w-full max-w-max-573">{{ get_the_excerpt($donut->ID) }}</p>
<span class="text-lg-font tablet-sm:text-xl-font font-reg420 pt-8 pb-4">Allergens</span>
                                    @if ($allergens)
...
<div class="tablet-sm:w-[100px] tablet-sm:mx-auto laptop:h-[700px] tablet-sm:absolute top-0 max-laptop:left-12 left-0 laptop:right-38 tablet-sm:right-[11.5rem] splide hidden tablet-sm:flex tablet-sm:items-center tablet-sm:justify-center tablet-sm:flex-col h-full" id="donut-thumb-slider">
...
<div class="splide__arrows flex flex-row justify-between w-full tablet-sm:flex-col-reverse tablet-sm:absolute tablet-sm:right-24 tablet-sm:-mt-40 tablet-sm:justify-end tablet-sm:items-end">
            <!-- Previous Button -->
<button class="splide__arrow splide__arrow--prev tablet-sm:left-auto tablet-sm:right-auto tablet-sm:flex tablet-sm:items-start tablet-sm:h-full relative tablet-sm:top-4">
                <!-- Large Device Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="67" viewBox="0 0 40 67" fill="none">
                    ...
                    <path class="trans" fill-rule="evenodd" clip-rule="evenodd" d="M21.5 60.3415L35.8454 43.0427C36.3742 42.405 37.3199 42.3167 37.9575 42.8455C38.5952 43.3743 38.6835 44.32 38.1547 44.9577L21.9244 64.5294C20.9247 65.735 19.0754 65.735 18.0756 64.5294L1.8454 44.9577C1.31659 44.32 1.40485 43.3743 2.04254 42.8455C2.68022 42.3167 3.62586 42.405 4.15468 43.0427L18.5 60.3415V3.00017C18.5 2.17174 19.1716 1.50017 20 1.50017C20.8285 1.50017 21.5 2.17174 21.5 3.00017V60.3415Z" fill="black"/>
                ...
                <!-- Smaller Device Icon -->
<span class="iconify tablet-sm:hidden text-black-full absolute" data-icon="ant-design:arrow-left-outlined" height="62px"></span>
            </button>

            <!-- Next Button -->
<button class="splide__arrow splide__arrow--next tablet-sm:left-auto tablet-sm:right-auto tablet-sm:flex tablet-sm:items-end tablet-sm:h-full">
                <!-- Large Device Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="67" viewBox="0 0 40 67" fill="none">
                ...
                <!-- Smaller Device Icon -->
<span class="iconify tablet-sm:hidden text-black-full absolute" data-icon="ant-design:arrow-right-outlined" height="62px"></span>
            </button>
        </div>
    </div>
</section>

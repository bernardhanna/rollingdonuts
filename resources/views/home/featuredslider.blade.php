            ...
            <div class="splide__list">
                @foreach ($featuredDonuts as $donut)
                    @php
                        ...
                        $description = apply_filters('the_content', $donut->post_content); // Get the product description and apply content filters
                    @endphp
                                            ...
                                            <ul class="allergen-list">
                                                @foreach ($allergens as $allergen)
                                                    <li class="flex items-center pb-[12px]">
                                                        <img src="{{ get_the_post_thumbnail_url($allergen->ID) }}"
                ...
                <div class="flex flex-col splide__list">
                    @foreach ($featuredDonuts as $donut)
                        <div
                            ...
                            <img src="{{ get_field('thumb_image', $donut->ID) }}"
                                alt="{{ $donut->post_title }} Thumbnail" height="48px" width="48px">
                        </div>
                    @endforeach
                </div>
            </div>

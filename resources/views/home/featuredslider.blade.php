...
<section class="featured-donuts relative bg-black" id="featured-section">
    <div class="splide" id="featured-slider">
        ...
        <div class="lg:w-[100px] lg:mx-auto lg:h-[700px] lg:absolute top-0 left-0 lg:right-[11.5rem] splide hidden lg:flex lg:items-center lg:justify-center lg:flex-col" id="donut-thumb-slider">

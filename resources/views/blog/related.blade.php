...
<aside>
    <h3 class="text-lg-font black-primary-full font-reg420 lg:pb-10">Related Articles</h3>
          ...
          <li class="border-2 boxshadow-three border-solid border-black-full rounded-sm-10 p-4">
              <a href="{{ get_permalink() }}" class="related-post">
                  @if(has_post_thumbnail())
                      ...
                      <img class="rounded-6xs w-full h-[310px] object-cover" src="{{ get_the_post_thumbnail_url() }}" srcset="{{ $post_image_srcset }}" sizes="(max-width: 267px) 100vw, 267px" alt="{{ get_the_title() }}" />
                  @endif

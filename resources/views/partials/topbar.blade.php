...
<section class="topbar bg-black-full hidden lg:flex max-w-sitewidth ml-auto mr-auto relative">
    <div class="{{ $containerClasses }}">
<div class="relative mx-auto flex justify-center items-center gap-2 lg:h-[40px]">

...
@if ($our_stories)
    <section id="ourstory"
             class="max-lg:pt-40 max-lg:pb-40 bg-right lg:bg-center bg-repeat bg-cover md:bg-contain max-lg:mb-20 max-lg:mt-20 z-50 our-story relative bg-black-full h-auto laptop:h-[900px]"
        ...
        <svg class="z-10 absolute -top-8 left-0 flex lg:hidden" xmlns="http://www.w3.org/2000/svg" width="108" height="110" viewBox="0 0 108 110" fill="none">
         ...
         <svg class="absolute top-0 left-0 flex lg:hidden" width="100%" viewBox="0 0 390 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="absolute inset-0 bg-black-full opacity-50 w-full h-full"></div>
        <div

...
@if ($our_stories)
    <section id="ourstory"
             class="max-lg:pt-40 max-lg:pb-40 bg-right lg:bg-center bg-repeat max-md:bg-cover max-lg:mb-20 max-lg:mt-20 z-40 our-story relative bg-black-full h-auto laptop:h-[900px]"

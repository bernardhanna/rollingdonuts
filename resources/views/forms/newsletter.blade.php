...
<form class="flex flex-row justify-center w-full" x-data="{
    ...
    <div class="flex flex-col lg:flex-row w-full justify-between lg:space-x-4">
        ...
        <label class="hidden lg:block text-white mob-sm-font fonts-reg420" for="name">Name</label>
        <div class="relative mb-4">
            ...
            text-mob-sm-font font-laca font-lig pl-11 flex w-full lg:max-w-max-358" name="name" type="text" placeholder="Your Name" required>
        </div>
    </div>
    <div class="flex flex-col w-full lg:justify-around">
        <label class="hidden lg:block text-white mob-sm-font fonts-reg420" for="emailAddress">Email Address</label>
        <div class="relative mb-4">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
            ...
            text-mob-sm-font font-laca font-light pl-11 flex w-full lg:max-w-max-358" name="emailAddress" type="email" placeholder="Email Address" required>
        </div>
    </div>
    ...
    <div class="flex flex-col w-full">
        <div class="flex lg:items-center leading-4 relative top-4">
            <input class="bg-white mr-[16px] h-[20px] w-[20px] rounded-[3px]" type="checkbox" required>

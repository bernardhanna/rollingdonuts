...
<x-html-forms
    ...
    class="flex flex-col justify-center w-full md:boxshadow-two md:rounded-form md:border md:bg-white md:border-black-full md:border-solid mobile:px-4 md:px-9 pt-8">
    @csrf
    <div class="flex flex-col w-full">
        <div class="flex flex-col tablet-sm:flex-row w-full md:justify-between">
            <div class="flex flex-col w-full">
                <label class="block text-black-full text-xs-font md:text-mob-md-font font-reg420 ml-2" for="name">First Name*</label>
                <div class="relative mb-4 md:mb-10">
                    ...
                    text-xs-font md:text-mob-md-font font-laca font-lig pl-11 flex w-full tablet-sm:max-w-max-95" name="name" type="text" placeholder="First Name" required>
                </div>
            </div>
            <div class="flex flex-col w-full">
                <label class="block text-black-full text-xs-font md:text-mob-md-font font-reg420 ml-2" for="name">Surname*</label>
                <div class="relative mb-4 md:mb-10">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 20 20"><path fill="#484848" d="M9.993 10.573a4.5 4.5 0 1 0 0-9a4.5 4.5 0 0 0 0 9ZM10 0a6 6 0 0 1 3.04 11.174c3.688 1.11 6.458 4.218 6.955 8.078c.047.367-.226.7-.61.745c-.383.045-.733-.215-.78-.582c-.54-4.19-4.169-7.345-8.57-7.345c-4.425 0-8.101 3.161-8.64 7.345c-.047.367-.397.627-.78.582c-.384-.045-.657-.378-.61-.745c.496-3.844 3.281-6.948 6.975-8.068A6 6 0 0 1 10 0Z"/></svg>
                    </div>
                    <input class="text-field rounded-lg-x h-input text-black-secondary
                    text-xs-font md:text-mob-md-font font-laca font-lig pl-11 flex w-full tablet-sm:max-w-max-95" name="name" type="text" placeholder="Surname" required>
                </div>
            </div>
        </div>
        <div class="flex flex-col tablet-sm:flex-row w-full md:justify-between">
            <div class="flex flex-col w-full">
                <label class="block text-black-full text-xs-font md:text-mob-md-font font-reg420 ml-2" for="emailAddress">Email*</label>
                <div class="relative mb-4 md:mb-10">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    text-xs-font md:text-mob-md-font font-laca font-light pl-11 flex w-full tablet-sm:max-w-max-95" name="emailAddress" type="email" placeholder="Email Address" required>
                </div>
            </div>
            <div class="flex flex-col w-full">
                <label class="block text-black-full text-xs-font md:text-mob-md-font font-reg420 ml-2" for="phone">Telephone*</label>
                <div class="relative mb-4 md:mb-10">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                    ...
                    <input class="rounded-lg-x h-input text-black-secondary
                    text-xs-font md:text-mob-md-font font-laca font-light pl-11 flex w-full tablet-sm:max-w-max-95" name="phone" type="text" placeholder="Telephone" required>
                </div>
            </div>
        </div>
        <div class="flex flex-col w-full">
            <label class="block text-black-full text-xs-font md:text-mob-md-font font-reg420 ml-2" for="phone">Message</label>
            <textarea class="rounded-sm-10 h-input text-black-secondary
            text-xs-font md:text-mob-md-font font-laca font-light pl-4 flex w-full min-h-[140px]" name="message" placeholder="Message" required></textarea>
        </div>
        <div class="flex flex-col w-full">
            <div class="flex lg:items-center leading-4 py-10">
                <input class="bg-white mr-2 h-[20px] w-[20px] rounded-sm border-grey-input flex flex-col border-2 border-solid" type="checkbox" required>
        ...
        <div class="flex flex-col w-full lg:w-auto">
            <label class="hidden invisible" for="name">Button</label>
            <input class="btn mb-4 md:mb-10 text-yellow-primary text-mob-lg-font lg:text-sm-md-font font-medium py-3 bg-black-full border-2 border-yellow-primary border-solid rounded-lg-x w-full mobile:w-[356px] hover:text-black-full hover:bg-yellow-primary" type="submit" value="Submit">
        </div>
    </div>

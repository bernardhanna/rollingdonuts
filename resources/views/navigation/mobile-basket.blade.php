...
<div class="fixed bottom-0 left-0 right-0 z-50 pt-4 px-4 pb-1 lg:hidden bg-black-full border-top-40 transition-opacity duration-500" x-show="itemCount > 0 && !atBottom && !hideOnPages" x-bind:class="{ 'opacity-0': atBottom || hideOnPages, 'opacity-100': !atBottom && !hideOnPages }">

<div class="mt-4" x-data="{ showFilter: false, isSmallScreen: window.innerWidth <= 1084 }">
    ...
    <div id="filter-slider-container h-full">
        <div x-show="showFilter" class="absolute h-full w-full text-black-full flex justify-center items-center top-full left-0 right-0">
            <ul id="custom-filter" class="ml-4 lg:pl-0 flex flex-nowrap overflow-x-auto flex-row justify-start h-full items-center gap-2">
